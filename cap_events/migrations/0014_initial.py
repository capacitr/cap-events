...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field site on 'Image'
        db.create_table('events_image_site', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('image', models.ForeignKey(orm['events.image'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('events_image_site', ['image_id', 'site_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field site on 'Image'
        db.delete_table('events_image_site')
